...
@section('content')
    @can('view dashboard')
                    ...
                    <div class="dash-user-card w-100">
                        ...
                        <div class="col-xl-5 d-flex ">
                            <div class="dash-user-card w-100">
                                ...
                                <div class="dash-btns">
                                    <a href="#" class="btn view-company-btn" id="generate-database-btn">Generate
                                        Database</a>
                                    <a href="#" class="btn view-package-btn" id="generate-monthly-billing-btn">Generate
                                        Monthly
                                        Billing</a>
                                </div>
                                <div class="dash-img">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="progress progress-sm mt-3">
                                            ...
                                            <div class="progress-bar" role="progressbar"
                                                style="width: 65%; background-color: #28a745;" aria-valuenow="65"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="progress progress-sm mt-3">
                                            ...
                                            <div class="progress-bar" role="progressbar"
                                                ...
                                                aria-valuenow="{{ ($totalBillingAmount / 100000) * 100 }}" aria-valuemin="0"
                                                aria-valuemax="100">
                                            </div>
                                        </div>
                                    </div>
        ...
        <script>
            ...
            $('#generate-database-btn').on('click', function(e) {
                e.preventDefault();

                // Prompt the user to enter the year
                let year = prompt("Enter the year for the database:");

                // Check if the user provided a year and it is valid
                if (year && !isNaN(year)) {
                    $.ajax({
                        url: "{{ route('generate.billing.database') }}",
                        method: 'POST',
                        data: {
                            _token: "{{ csrf_token() }}",
                            year: year
            ...
            $('#generate-monthly-billing-btn').on('click', function(e) {
                e.preventDefault();

                $.ajax({
                    url: "{{ route('generate.monthly.billing') }}",
                    method: 'POST',
                    data: {
                        _token: "{{ csrf_token() }}"
                    },
                    ...
                    error: function() {
                        alert("An error occurred while generating the monthly billing.");
                    }
                });
            });
        </script>
