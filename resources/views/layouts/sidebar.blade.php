        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <nav class="greedys sidebar-horizantal">
                <ul class="list-inline-item list-unstyled links">
                    ...
                    <li class="submenu">
                        <a href="#"><i class="fe fe-user"></i> <span> Dashboard </span> <span
                    ...
                    <li class="submenu">
                        <a href="#"><span> <i class="fe fe-users"></i> Customers</span> <span
                                class="menu-arrow"></span></a>
                        <ul>
            ...
            <ul class="sidebar-vertical">
                ...
                <li class="submenu">
                    <a href="#" class=""><i class="fe fe-user"></i> <span> Dashboard</span> <span
                            class="menu-arrow"></span></a>
                    <!-- <ul>
                        <li><a href="dashboard.html" class="active">Dashboard</a></li>
                        <li><a href="companies.html">Companies</a></li>
                ...
                <li>
                    <a href="customers.html"><i class="fe fe-users"></i> <span>Apartments</span></a>
                </li>
                <li>
                    <a href="customers.html"><i class="fe fe-users"></i> <span>Students</span></a>
                </li>
