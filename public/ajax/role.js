                        ...
                        <td class="d-flex align-items-center">
                            <div class="dropdown dropdown-action">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <ul>
                                        <li><a class="dropdown-item edit-roles-btn" data-id="${RoleAll.id}"><i class="far fa-edit me-2"></i>${translations.edit}</a></li>
                                        <li><a class="dropdown-item delete-roles-btn" data-id="${RoleAll.id}"><i class="far fa-trash-alt me-2"></i>${translations.delete}</a></li>
                                    </ul>
                                </div>
                            </div>
                        </td>
